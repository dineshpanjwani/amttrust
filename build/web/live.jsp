...
<link rel='stylesheet prefetch' href='https://fonts.googleapis.com/css?family=Roboto:300'>
  ...
  <div class="header-inner clearfix">
    ...
    <div class="header-search">
      ...
      <div class="container">
  <br/><br/> <br/>
  <div><h3><u>Todays/Live Kirtan</u></h3></div>
  <div class="row">
       <%
            Date date=new Date();
       SimpleDateFormat ft = 
         new SimpleDateFormat ("dd'th' MMMMMMMMMM, yyyy");
         String dt=ft.format(date);
            
            String urlss = "https://www.genyoutube.net/search.php?q=amritvela%20trust";
      Document documentss = Jsoup.connect(urlss).get();
      
      
      for(int i=0;i<21;i++)
      { 
       Element linkdss = documentss.select(".row .duration").get(i);
      //out.println("Heading :"+linkdss.text()+"<br/>");
      Element details = documentss.select(".detail .narrowtitle a").get(i);
     
       Element publisher = documentss.select(".detail .pull-left a").get(i);
      
       
       
       
       Element ids = documentss.select(".row .vidbox").get(i);
       
       Element detail = documentss.select(".detail").get(i);
       
       Element views = documentss.select(".label-views").get(i);
       
       Element linkds = documentss.select(".row img").get(i);
       
       
         
       
       if(details.text().contains(dt)){
      ...
      <div class="thumbnail">
        <%out.println("<a href=full.jsp?search="+ids.attr("id")+">");%>
          ...
          <div class="caption">
              ...
              <p></p>
              <p style="font-size: 12px;"> <%String txt=detail.text().replace("AmritVela Live Kirtan - 28th May, 2018 AMRITVELA TRUST ", "");
